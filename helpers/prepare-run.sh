...
: ${SOURCE_RAMDISK_DIR=~/aug19-pscgbuildos/build/target/product/pscg_busyboxos/build-x86_64/ramdisk/initramfs/}
: ${FAKE_FILES_DIR=~/pscgdockos-materials/runtime-materials/dockosrd/fakestuff/fake-files/}
: ${FAKE_FILES_DIR=~/pscgdockos-materials/runtime-materials/dockosrd/fakestuff/fake-files/}
: ${LOWER_DIR_UNPACKED_RAMDISK=~/pscgdockos-materials/runtime-materials/pscgdockos/initramfs-unpacked}
...
echo -e "[+] DONE. You may run with\ninitrdfs_host_path=/tmp/dockos-rd-overlays/merged/  ./helpers/2025-run.sh"
